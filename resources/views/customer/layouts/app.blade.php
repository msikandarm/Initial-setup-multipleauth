  ...
  <div class="app_wrapper">
    ...
    <div class="sidepanel">
      <div class="sidepanel_header">
        <div class="logo"><img src="{{ asset('assets/backend/image/newlogo.png') }}" alt="logo"></div>
      </div>
      <div class="sidepanel_body">
        <ul class="sidebar_menu">
          <li><a href="{{ route('dashboard') }}"><i class="las la-tachometer-alt"></i> {{ __('Dashboard') }}</a></li>
          <li><a href="#"><i class="las la-store"></i> {{ __('Orders') }}</a></li>
          <li><a href="#"><i class="las la-file"></i> {{ __('Reports ') }}</a></li>
        </ul>
      </div>
    </div>
              ...
              <li>
                <div class="dropdown profile_dropdown">
                  <button class="btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <span class="short_username">{{ substr(auth()->guard('customer')->user()->name ?? ' ', 0, 1) }}</span>
                    <span>{{ auth()->guard('customer')->user()->name ?? ' ' }}</span>
                  </button>
                  <div class="dropdown-menu">
                    <ul>
                      <li><a class="dropdown-item" href="#"><i class="las la-user"></i> {{ __('Profile') }}</a></li>
